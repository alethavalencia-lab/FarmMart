  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Button 
              onClick={() => isDashboard ? setIsSearchOpen(true) : handleActionClick({} as any)} 
              variant="ghost" 
              size="icon" 
              className={cn(
      ...
      <Dialog open={isSearchOpen} onOpenChange={setIsSearchOpen}>
        <DialogContent className="rounded-[2.5rem] border-none glassmorphism sm:max-w-[600px] p-8 outline-none">
          <DialogHeader>
            <DialogTitle className="text-2xl font-black font-headline text-primary">Cari Hasil Tani</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleSearchSubmit} className="relative mt-4">
            ...
            <Input 
              ...
              placeholder="Ketik tomat, beras, cabai..." 
              className="pl-12 h-14 rounded-2xl border-none bg-primary/5 text-foreground text-lg focus-visible:ring-primary shadow-inner"
              autoFocus
            />
            <Button type="submit" className="absolute right-2 top-2 h-10 rounded-xl bg-primary text-white font-bold">Cari</Button>
          </form>
        </DialogContent>
      </Dialog>
    </>
