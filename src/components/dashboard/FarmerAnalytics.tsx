...
const topProducts = [
  ...
  { name: "Beras Cianjur", value: 45, color: "hsl(var(--accent))" },
  ...
  if (!mounted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
        ...
        <p className="text-muted-foreground font-medium">Memuat data analitik...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "Total Penjualan Bulan Ini", value: "1,245 Kg", trend: "+8.2%", up: true, icon: ShoppingBag, bg: "bg-primary/10", color: "text-primary" },
          { label: "Total Panen", value: "4,500 Kg", trend: "+12.4%", up: true, icon: Package, bg: "bg-blue-50", color: "text-blue-600" },
          { label: "Total Pendapatan", value: "Rp 154.2M", trend: "+12.4%", up: true, icon: DollarSign, bg: "bg-secondary/10", color: "text-secondary" },
          { label: "Jumlah Produk Aktif", value: "12 Jenis", trend: "Stabil", up: true, icon: Target, bg: "bg-accent/10", color: "text-accent" },
        ].map((stat, i) => (
          <Card key={i} className="rounded-3xl border-none shadow-lg glassmorphism">
            <CardContent className="p-6">
              <div className={cn("p-2.5 rounded-xl w-fit mb-4", stat.bg)}>
        ...
        <Card className="lg:col-span-2 rounded-[2.5rem] border-none shadow-xl bg-white p-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-1.5 rounded-full bg-primary text-white text-[10px] font-bold">Bulanan</button>
              <button className="px-4 py-1.5 rounded-full bg-primary/5 text-muted-foreground text-[10px] font-bold">Tahunan</button>
            </div>
          </div>
      ...
      {/* Prediksi Permintaan Produk & AI Assistant */}
      <div className="grid lg:grid-cols-3 gap-8">
        <Card className="lg:col-span-2 rounded-[2.5rem] border-none shadow-xl bg-white p-8 overflow-hidden relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 relative z-10">
              ...
              <div className="p-6 bg-primary/5 rounded-3xl border border-primary/10">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <h4 className="text-xl font-bold text-primary">Tomat Ceri</h4>
                  </div>
            ...
            <div className="grid grid-cols-2 gap-4">
               {[
                 { label: "Est. Demand Mingguan", value: "12.500 Kg", icon: ShoppingBag, color: "text-blue-500", bg: "bg-blue-50" },
                 { label: "Tren Permintaan", value: "Naik +8%", icon: ArrowUpRight, color: "text-green-500", bg: "bg-green-50" },
                 ...
                 <div key={i} className="p-4 rounded-2xl border border-primary/5 bg-white shadow-sm flex flex-col justify-between">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-muted-foreground uppercase leading-tight">{item.label}</p>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/10 rounded-2xl border border-white/10 backdrop-blur-sm">
                   <p className="text-xs italic leading-relaxed">
                     "Permintaan tomat ceri diperkirakan meningkat dalam beberapa hari ke depan. Pertimbangkan untuk meningkatkan distribusi panen Anda hari ini."
                   </p>
                </div>
