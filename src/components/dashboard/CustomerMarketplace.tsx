...
export const mockProducts = [
  // Sayuran
  { id: 1, name: "Cabai Merah Premium", category: "Sayuran", price: 32000, farmer: "Pak Maman", location: "Lembang, Jawa Barat", rating: 4.8, reviews: 124, status: "Tersedia", badges: ["Best Seller", "Panen Hari Ini"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781924019/OIP_4_xwysrb.webp", stock: "85 kg", harvestDate: "2026-05-20", description: "Cabai merah segar pilihan langsung dari kebun Lembang." },
  { id: 2, name: "Tomat Organik", category: "Sayuran", price: 18500, farmer: "Ibu Siti", location: "Cianjur, Jawa Barat", rating: 4.9, reviews: 86, status: "Tersedia", badges: ["Organik"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781924354/fresh-tomato-1000x1000_dej5yi.jpg", stock: "42 kg", harvestDate: "2026-05-18", description: "Tomat organik tanpa pestisida kimia." },
  { id: 4, name: "Jagung Manis", category: "Sayuran", price: 12000, farmer: "Pak Budi", location: "Garut, Jawa Barat", rating: 4.7, reviews: 52, status: "Stok Tipis", badges: ["Panen Hari Ini"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781926868/OIP_6_olhwhl.webp", stock: "15 kg", harvestDate: "2026-05-20", description: "Jagung manis segar panen harian." },
  { id: 10, name: "Bayam Hijau Segar", category: "Sayuran", price: 8000, farmer: "Pak Jaka", location: "Bandung, Jawa Barat", rating: 4.6, reviews: 34, status: "Tersedia", badges: ["Organik"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781927235/R_2_vjblmf.jpg", stock: "20 kg", harvestDate: "2026-05-21", description: "Bayam organik kaya zat besi." },
  
  // Buah-buahan
  { id: 7, name: "Pisang Cavendish", category: "Buah-buahan", price: 25000, farmer: "Kelompok Tani Lampung", location: "Lampung, Sumatera", rating: 4.9, reviews: 156, status: "Tersedia", badges: ["Fresh"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781923926/OIP_3_hunjmr.webp", stock: "80 sisir", harvestDate: "2026-05-19", description: "Pisang Cavendish kualitas premium." },
  { id: 8, name: "Alpukat Mentega", category: "Buah-buahan", price: 35000, farmer: "Pak Jaka", location: "Probolinggo, Jawa Timur", rating: 4.7, reviews: 94, status: "Tersedia", badges: ["Organik"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781924191/istockphoto-1824689302-612x612_oyxubg.jpg", stock: "55 kg", harvestDate: "2026-05-15", description: "Alpukat mentega super creamy." },
  { id: 11, name: "Mangga Harum Manis", category: "Buah-buahan", price: 28000, farmer: "Ibu Ratna", location: "Indramayu, Jawa Barat", rating: 4.8, reviews: 72, status: "Tersedia", badges: ["Best Seller"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781926593/678e2a8d30c4c4998dc01be6725efbaf_cricny.jpg", stock: "100 kg", harvestDate: "2026-05-10", description: "Mangga manis harum asli Indramayu." },
  { id: 12, name: "Jeruk Medan Super", category: "Jeruk Medan Super", price: 22000, farmer: "Pak Ginting", location: "Berastagi, Sumatera", rating: 4.5, reviews: 45, status: "Tersedia", badges: [], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781926914/OIP_7_w8tygb.webp", stock: "60 kg", harvestDate: "2026-05-12", description: "Jeruk manis segar dari tanah Karo." },

  // Biji-bijian
  { id: 3, name: "Beras Premium Cianjur", category: "Biji-bijian", price: 16500, farmer: "Pak Arif", location: "Cianjur, Jawa Barat", rating: 5.0, reviews: 245, status: "Tersedia", badges: ["Best Seller"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781923565/ir-64-parboiled-rice-5-broken-1000x1000_gibiwb.jpg", stock: "500 kg", harvestDate: "2026-04-15", description: "Beras Pandan Wangi asli Cianjur." },
  { id: 13, name: "Kedelai Lokal", category: "Biji-bijian", price: 14000, farmer: "Pak Slamet", location: "Grobogan, Jawa Tengah", rating: 4.6, reviews: 28, status: "Tersedia", badges: [], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781927234/quality-soybeans-1697958844-7141025_yjd2p9.jpg", stock: "200 kg", harvestDate: "2026-05-01", description: "Kedelai lokal berkualitas untuk tahu tempe." },

  // Rempah-rempah
  { id: 9, name: "Jahe Merah Super", category: "Rempah-rempah", price: 28000, farmer: "Pak Maman", location: "Lembang, Jawa Barat", rating: 4.8, reviews: 42, status: "Tersedia", badges: ["Best Seller"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781927234/OIP_8_giltky.webp", stock: "40 kg", harvestDate: "2026-05-12", description: "Jahe merah segar berkualitas tinggi." },
  { id: 6, name: "Bawang Merah Brebes", category: "Rempah-rempah", price: 45000, farmer: "Ibu Rahma", location: "Brebes, Jawa Tengah", rating: 4.6, reviews: 78, status: "Tersedia", badges: [], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781924456/S955108bd168e427ca4d6f6b3fab9aad5P.jpg_720x720q80_flqt6y.jpg", stock: "250 kg", harvestDate: "2026-05-05", description: "Bawang merah Brebes aroma kuat." },

  // Tanaman Herbal
  { id: 14, name: "Temulawak Segar", category: "Tanaman Herbal", price: 15000, farmer: "Pak Hendra", location: "Sukabumi, Jawa Barat", rating: 4.7, reviews: 19, status: "Tersedia", badges: ["Herbal"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781927233/product-jpeg-500x500_igja6m.webp", stock: "30 kg", harvestDate: "2026-05-14", description: "Temulawak segar untuk jamu kesehatan." },
  { id: 15, name: "Daun Mint Organik", category: "Tanaman Herbal", price: 12000, farmer: "Ibu Lani", location: "Bandung, Jawa Barat", rating: 4.9, reviews: 22, status: "Tersedia", badges: ["Organik"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781927234/how_get_big_mint_leaves-1024x683_ylokw3.jpg", stock: "5 kg", harvestDate: "2026-05-20", description: "Daun mint segar aromatik." },
  { id: 16, name: "Rosella Kering", category: "Tanaman Herbal", price: 55000, farmer: "Kelompok Wanita Tani", location: "Yogyakarta, DIY", rating: 5.0, reviews: 56, status: "Tersedia", badges: ["Best Seller"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781926697/OIP_5_ppydxg.webp", stock: "15 kg", harvestDate: "2026-04-30", description: "Bunga rosella kering kaya antioksidan." },

  // Kacang-kacangan
  { id: 18, name: "Kacang Tanah Kupas", category: "Kacang-kacangan", price: 32000, farmer: "Pak Agus", location: "Tuban, Jawa Timur", rating: 4.7, reviews: 67, status: "Tersedia", badges: ["Best Seller"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781926638/brd-69012_kacang-tanah-kupas-500g_full01_jwnt6c.webp", stock: "100 kg", harvestDate: "2026-05-02", description: "Kacang tanah kupas kering berkualitas." },
  { id: 19, name: "Edamame Segar", category: "Kacang-kacangan", price: 24000, farmer: "Ibu Desi", location: "Jember, Jawa Timur", rating: 4.9, reviews: 89, status: "Tersedia", badges: ["Organik", "Fresh"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781924282/istockphoto-1066735052-170667a_uoqkvk.jpg", stock: "40 kg", harvestDate: "2026-05-21", description: "Edamame jepang kualitas ekspor." },

  // Umbi-umbian
  { id: 23, name: "Kentang Dieng Super", category: "Umbi-umbian", price: 15000, farmer: "Pak Budi", location: "Wonosobo, Jawa Tengah", rating: 4.8, reviews: 110, status: "Tersedia", badges: ["Best Seller"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781924144/potatoes-are-a-good-food-source-because-they-contain-fiber-carbohydrates-vitamin-c-and-potassium-free-photo_ruptcx.jpg", stock: "200 kg", harvestDate: "2026-05-15", description: "Kentang Dieng kualitas super." },
  { id: 27, name: "Ubi Cilembu Madu", category: "Umbi-umbian", price: 20000, farmer: "Ibu Ratna", location: "Sumedang, Jawa Barat", rating: 5.0, reviews: 230, status: "Tersedia", badges: ["Best Seller", "Manis"], image: "https://res.cloudinary.com/dhp46iviu/image/upload/v1781923659/OIP_2_smtj9t.webp", stock: "100 kg", harvestDate: "2026-05-10", description: "Ubi Cilembu asli Sumedang, manis seperti madu." },
];
...
export function CustomerMarketplace({ addToCart, toggleFavorite, favorites, startCheckout, cartCount, setView }: MarketplaceProps) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    else if (sortBy === "latest") result.sort((a, b) => a.id - a.id);
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-primary/5 rounded-3xl border border-primary/10">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs font-black uppercase tracking-widest text-muted-foreground">Petani</p>
